      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end"><button type="button" onClick={() => onNavigate('reset-password')} className="text-sky-600 text-xs font-medium hover:underline">Forgot password?</button></div>
